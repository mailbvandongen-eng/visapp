...
import { Layers, Anchor, Ship, Waves, MapPin, Check, Tag, Mountain, X, Droplets, ExternalLink, CircleDot, Landmark, Ruler } from 'lucide-react'
...
const VIS_LAYERS = [
  ...
  { name: 'Bathymetrie', icon: Ruler, color: '#7C3AED' },
